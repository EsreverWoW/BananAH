...
function InternalInterface.UI.SearchFrame(name, parent)
	...
	searchGrid:AddColumn("item", L["SearchFrame/ColumnItem"], SearchCellType, 120, 3, nil, "itemName")
	searchGrid:AddColumn("seller", L["SearchFrame/ColumnSeller"], "Text", 80, 1, "sellerName", true, { Alignment = "center" })
	searchGrid:AddColumn("remaining", L["SearchFrame/ColumnRemaining"], "Text", 80, 0, "remainingTime", true, { Alignment = "center", Formatter = RemainingTimeFormatter })
	searchGrid:AddColumn("bid", L["SearchFrame/ColumnBid"], "MoneyCellType", 150, 0, "bidPrice", true, { Alignment = "right" })
	searchGrid:AddColumn("buy", L["SearchFrame/ColumnBuy"], "MoneyCellType", 150, 0, "buyoutPrice", true, { Alignment = "right" })
	searchGrid:AddColumn("unitbid", L["SearchFrame/ColumnBidPerUnit"], "MoneyCellType", 150, 0, "bidUnitPrice", true, { Alignment = "right" })
	searchGrid:AddColumn("unitbuy", L["SearchFrame/ColumnBuyPerUnit"], "MoneyCellType", 150, 0, "buyoutUnitPrice", true, { Alignment = "right" })
	searchGrid:AddColumn("score", L["SearchFrame/ColumnScore"], "Text", 62, 0, "score", true, { Alignment = "center", Formatter = ScoreValue, Color = ScoreColor })
