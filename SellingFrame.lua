...
function InternalInterface.UI.SellingFrame(name, parent)
	...
	sellingGrid:AddColumn("remaining", L["SellingFrame/ColumnRemaining"], "Text", 100, 0, "remainingTime", true, { Alignment = "center", Formatter = RemainingTimeFormatter })
	...
	-- sellingGrid:SetOrder("remaining", false)
